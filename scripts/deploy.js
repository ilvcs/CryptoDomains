...
const main = async () => {
  ...
  const txn = await domainContract.register('supercool', {
    value: hre.ethers.utils.parseEther('0.1'),
  })
  await txn.wait()
  console.log(`Minted domain supercool.hello`)

  const domainOwner = await domainContract.getOwner('supercool')
  console.log(`Owner of the domain supercool.hello is ${domainOwner}`)
